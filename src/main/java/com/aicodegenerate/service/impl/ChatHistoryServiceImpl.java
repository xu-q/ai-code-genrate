...
import com.aicodegenerate.mapper.ChatHistoryMapper;
...
public class ChatHistoryServiceImpl extends ServiceImpl<ChatHistoryMapper, ChatHistory> implements ChatHistoryService {
    ...
    @Resource
    @Lazy //解决appServiceImpl 和 chatHistoryServiceImpl 循环依赖问题， ChatHistory功能没有AppService重要，所以appService在此类中延迟加载
    ...
    public Page<ChatHistory> listAppChatHistoryByPage(Long appId, int pageSize, LocalDateTime lastCreateTime, User loginUser) {
        ...
        // 查询数据，pageNumber为1，是因为用游标查询会定位到查询的数据位置，始终从第1页开始查询即可，不是平常的分页查询

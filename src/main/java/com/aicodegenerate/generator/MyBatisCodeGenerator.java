package com.aicodegenerate.generator;
...
public class MyBatisCodeGenerator {
    ...
    public static GlobalConfig createGlobalConfig() {
        ...
        globalConfig.getPackageConfig().setBasePackage("com.aicodegenerate.generator.result");
        ...
        globalConfig.getJavadocConfig().setAuthor("xu").setSince("");
        return globalConfig;
    }
}
